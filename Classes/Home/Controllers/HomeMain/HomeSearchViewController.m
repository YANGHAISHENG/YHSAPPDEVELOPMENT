...
@interface HomeSearchViewController () <UITabBarDelegate, UITableViewDataSource, YHSSearchViewControllerDelegate>
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    YHSSearchViewController *searchViewController = [YHSSearchViewController searchViewControllerWithHotSearches:hotSeaches searchBarPlaceholder:@"搜索编程语言" didSearchBlock:^(YHSSearchViewController *searchViewController, UISearchBar *searchBar, NSString *searchText) {
        // 开始搜索执行以下代码
        // 如：跳转到指定控制器
        HomeSearchResultViewController *searchResultVC = [[HomeSearchResultViewController alloc] init];
        [searchResultVC setTitle:searchText];
